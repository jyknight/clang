...
OffsetOfExpr *OffsetOfExpr::Create(const ASTContext &C, QualType type,
  ...
  void *Mem = C.Allocate(totalSizeToAlloc<OffsetOfNode, Expr*>(comps.size(), exprs.size()));
...
OffsetOfExpr *OffsetOfExpr::CreateEmpty(const ASTContext &C,
  ...
  void *Mem = C.Allocate(totalSizeToAlloc<OffsetOfNode, Expr*>(numComps, numExprs));
...
DesignatedInitExpr *DesignatedInitExpr::CreateEmpty(const ASTContext &C,
  ...
  void *Mem = C.Allocate(totalSizeToAlloc<Stmt *>(NumIndexExprs + 1), llvm::alignOf<DesignatedInitExpr>());
...
PseudoObjectExpr *PseudoObjectExpr::Create(const ASTContext &Context,
  ...
  void *buffer = Context.Allocate(totalSizeToAlloc<Expr*>(1 + numSemanticExprs),
