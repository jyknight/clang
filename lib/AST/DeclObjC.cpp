...
void ObjCMethodDecl::setParamsAndSelLocs(ASTContext &C,
  ...
  static_assert(llvm::AlignOf<ParmVarDecl*>::Alignment >= llvm::AlignOf<SourceLocation>::Alignment, "Alignment not sufficient for SourceLocation");
...
ObjCTypeParamList *ObjCTypeParamList::create(
                     ...
                     ArrayRef<ObjCTypeParamDecl *> typeParams,
                     SourceLocation rAngleLoc) {
  void *mem = ctx.Allocate(totalSizeToAlloc<ObjCTypeParamDecl *>(typeParams.size()), llvm::alignOf<ObjCTypeParamList>());
