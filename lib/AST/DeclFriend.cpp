...
FriendDecl *FriendDecl::Create(ASTContext &C, DeclContext *DC,
  ...
  std::size_t Extra = FriendDecl::additionalSizeToAlloc<TemplateParameterList*>(FriendTypeTPLists.size());
...
FriendDecl *FriendDecl::CreateDeserialized(ASTContext &C, unsigned ID,
  ...
  std::size_t Extra = additionalSizeToAlloc<TemplateParameterList *>(FriendTypeNumTPLists);
