...
void ASTStmtReader::VisitOffsetOfExpr(OffsetOfExpr *E) {
  ...
  for (unsigned I = 0, N = E->getNumComponents(); I != N; ++I) {
    ...
    case OffsetOfNode::Field:
      E->setComponent(I, OffsetOfNode(Start, ReadDeclAs<FieldDecl>(Record, Idx), End));
      break;
...
void ASTStmtReader::VisitObjCDictionaryLiteral(ObjCDictionaryLiteral *E) {
  ...
  ObjCDictionaryLiteral::KeyValuePair *KeyValues = E->getTrailingObjects<ObjCDictionaryLiteral::KeyValuePair>();
  ObjCDictionaryLiteral::ExpansionData *Expansions = E->getTrailingObjects<ObjCDictionaryLiteral::ExpansionData>();
