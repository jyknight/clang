...
class OffsetOfExpr final : public Expr, private llvm::TrailingObjects<OffsetOfExpr, OffsetOfNode, Expr *> {
  friend TrailingObjects;
...
///
class MemberExpr final : public Expr, private llvm::TrailingObjects<MemberExpr, MemberExprNameQualifier, ASTTemplateKWAndArgsInfo>  {
  friend TrailingObjects;
  ...
  /// after the MemberExprNameQualifier structure.
...
class DesignatedInitExpr final : public Expr, private llvm::TrailingObjects<DesignatedInitExpr, Stmt *> {
  friend TrailingObjects;
...
/// modelling design.
class PseudoObjectExpr final : public Expr, private llvm::TrailingObjects<PseudoObjectExpr, Expr *> {
  friend TrailingObjects;
